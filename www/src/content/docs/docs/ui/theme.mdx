...
- <p>[<code class="key">font?</code>](#theme.font) <code class="symbol">&lcub; </code><code class="key">family</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">scale</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol"> &rcub;</code></p>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="symbol">&lcub; </code><code class="key">family</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">scale</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol"> &rcub;</code>
</InlineSection>
</Section>
