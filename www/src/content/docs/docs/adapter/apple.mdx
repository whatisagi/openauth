...
#### Parameters
- <p><code class="key">config</code> [<code class="type">AppleConfig</code>](/docs/adapter/apple#appleconfig)</p>
...
<Section type="parameters">
#### Parameters
- <p><code class="key">config</code> [<code class="type">AppleOidcConfig</code>](/docs/adapter/apple#appleoidcconfig)</p>
</Section>
<InlineSection>
**Returns** <code class="type">Adapter</code>
</InlineSection>
