...
- <p>[<code class="key">endpoint</code>](#oauth2config.endpoint) <code class="symbol">&lcub; </code><code class="key">authorization</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">token</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol"> &rcub;</code></p>
...
<Section type="parameters">
<InlineSection>
**Type** <code class="symbol">&lcub; </code><code class="key">authorization</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol">, </code><code class="key">token</code><code class="symbol">&colon; </code><code class="primitive">string</code><code class="symbol"> &rcub;</code>
</InlineSection>
</Section>
